...
{
    /// <summary>
    /// This class is adapted from Ken Perlins original java source code (http://mrl.nyu.edu/~perlin/)
    /// </summary>
    public class PerlinNoise
    {
        ...
        {
            int h = hash & 15; //Convert the lower 4 bits of the hash code into 12 gradient directions
